...
pub fn generate(
    x_size: u32,
    y_size: u32,
) -> Result<GreyImage, Box<dyn Error>> {
...
pub fn generate_colour( // because Ben is british color is spelled colour.
    x_size: u32,
    y_size: u32,
...
mod tests {
    ...
    #[ignore] 
    fn try_generate() {
        generate_colour(2_000, 2_000).unwrap().save("./result.png").unwrap();
    }
    #[test]
    fn check_rect() {
